        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventoId = table.Column<string>(type: "TEXT", nullable: true),
                    EventoId1 = table.Column<int>(type: "INTEGER", nullable: true),
                    PalestranteId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedesSocial", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedesSocial_Eventos_EventoId1",
